...
// in aipet_frontend/test/unit/features/pet_registor/domain/services/pet_registration_controller_test.dart.
...
class MockProviderRef<State> extends _i1.Mock
    implements _i3.ProviderRef<State> {
  MockProviderRef() {
  ...
  State get state =>
      (super.noSuchMethod(
            ...
            returnValue: _i4.dummyValue<State>(this, Invocation.getter(#state)),
          )
          as State);
