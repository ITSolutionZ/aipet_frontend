...
class AiRepositoryImpl implements AiRepository {
  ...
  AiRepositoryImpl({required this.ref})
    : _localStorageService = AiLocalStorageService(),
      _localStorage = LocalDataManager.instance;
  ...
  Future<List<AiSuggestedQuestionEntity>> getSuggestedQuestions() async {
    // 로컬 저장소에서 추천 질문 가져오기
    final questions = await _localStorageService.loadSuggestedQuestions();
    return questions; // loadSuggestedQuestions()가 이미 List<AiSuggestedQuestionEntity>를 반환
  }
