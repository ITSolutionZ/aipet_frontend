...
import '../../../../../features/settings/presentation/widgets/settings_tile_widget.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          if (kDebugMode) ...[
            const SizedBox(height: AppSpacing.lg),
            const SectionHeaderWidget(title: '開発者ツール'),
            SettingsTileWidget(
              icon: Icons.api,
              title: 'バックエンドAPI テスト',
              backgroundColor: const Color(0xFF6B73FF),
              tileColor: AppColors.pureWhite,
              onTap: () => context.push(RouteConstants.apiTestRoute),
            ),
          ],
