...
import '../../core/utils/loading_state.dart' as core_loading;

/// 표준화된 로딩 위젯
class LoadingWidget extends StatelessWidget {
  final core_loading.LoadingState loadingState;
  final Widget? child;
...
class LoadingStateBuilder extends StatelessWidget {
  final core_loading.LoadingState loadingState;
  final Widget Function(BuildContext context, core_loading.LoadingState state)
      builder;
