import 'package:aipet_frontend/shared/ui/components/app_button.dart' as app_btn;
import 'package:flutter/material.dart';

import '../../../shared/shared.dart' hide ButtonSize;
...
class PointOutlinedButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppButton(
      ...
      size: app_btn.ButtonSize.medium,
      isLoading: isLoading,
      leading: leading,
      trailing: trailing,
      borderColor: borderColor,
