...
class PetCoreController extends CrudController<PetProfileEntity> {
  ...
  late final GetPetByIdUseCase _getPetByIdUseCase = ref.read(getPetByIdUseCaseProvider);
  ...
  @override
  Future<coreResult.Result<PetProfileEntity>> create(PetProfileEntity pet) async {
    try {
  ...
  @override
  Future<coreResult.Result<PetProfileEntity>> update(PetProfileEntity pet) async {
    try {
