...
/// 🔍 메시지 분석 UseCase
class AnalyzeMessageUseCase extends BaseUseCase<AiAnalysisEntity, AnalyzeMessageParams> {
  final AiRepository _repository;

  AnalyzeMessageUseCase(this._repository);

  @override
  Future<Result<AiAnalysisEntity>> execute(AnalyzeMessageParams params) async {
    return await _repository.analyzeMessage(
