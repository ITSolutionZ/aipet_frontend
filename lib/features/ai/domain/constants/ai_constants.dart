...
class AiUIConstants {
  // 애니메이션 지속 시간
  static const Duration typingAnimationDuration = const Duration(milliseconds: 1500);
  static const Duration messageAnimationDuration = const Duration(milliseconds: 300);
  static const Duration fadeAnimationDuration = const Duration(milliseconds: 200);
  ...
  // 타이핑 인디케이터 설정
  static const Duration typingIndicatorDelay = const Duration(milliseconds: 500);
