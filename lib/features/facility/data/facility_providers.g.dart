...
String _$facilityListNotifierHash() =>
    r'807dd23db310fe85abbdc37a0d4adeab1129380c';

/// See also [FacilityListNotifier].
@ProviderFor(FacilityListNotifier)
final facilityListNotifierProvider =
    AutoDisposeNotifierProvider<FacilityListNotifier, List<Facility>>.internal(
...
typedef _$FacilityListNotifier = AutoDisposeNotifier<List<Facility>>;
