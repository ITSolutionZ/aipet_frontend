...
final saveNotificationSettingsUseCaseProvider = Provider<SaveNotificationSettingsUseCase>((ref) {
...
final requestNotificationPermissionUseCaseProvider = Provider<RequestNotificationPermissionUseCase>((ref) {
  return RequestNotificationPermissionUseCase(ref.read(notificationRepositoryProvider));
});

final testNotificationUseCaseProvider = Provider<TestNotificationUseCase>((ref) {
...
final notificationControllerFactoryProvider = Provider.family<NotificationController, WidgetRef>((ref, widgetRef) {
...
final notificationDetailControllerFactoryProvider = Provider.family<NotificationDetailController, WidgetRef>((ref, widgetRef) {
