...
class PetProfileCardRefactored extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PetProfileCardRefactored> createState() =>
      _PetProfileCardRefactoredState();
}

class _PetProfileCardRefactoredState
    extends ConsumerState<PetProfileCardRefactored> {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: AppSpacing.md),
              Text('ペット情報の読み込みに失敗しました', style: AppFonts.bodyMedium),
