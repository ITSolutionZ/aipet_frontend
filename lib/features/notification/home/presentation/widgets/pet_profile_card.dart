...
final petProfileCardProvider =
    StateNotifierProvider<PetProfileCardController, PetProfileCardState>(
...
class PetProfileCardState {
  ...
  const PetProfileCardState({this.pageController});

  PetProfileCardState copyWith({PageController? pageController}) {
