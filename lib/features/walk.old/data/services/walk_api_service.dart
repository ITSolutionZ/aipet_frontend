...
class WalkApiService {
  ...
  Future<Result<List<WalkRecordEntity>>> getAllWalkRecords() async {
    try {
      debugPrint('🌐 WalkAPI: 전체 산책 기록 조회 요청');
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint('✅ WalkAPI: ${records.length}개 산책 기록 조회 성공');
        return Result.success('산책 기록을 가져왔습니다', records);
      }

      debugPrint('⚠️ WalkAPI: 응답 데이터 없음');
      return Result.failure('산책 기록을 가져올 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 산책 기록 조회 실패 - $e');
  ...
  Future<Result<WalkRecordEntity>> getWalkRecordById(String id) async {
    try {
      debugPrint('🌐 WalkAPI: 산책 기록 조회 - ID: $id');
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint('✅ WalkAPI: 산책 기록 조회 성공 - ID: $id');
        return Result.success('산책 기록을 가져왔습니다', record);
      }

      debugPrint('⚠️ WalkAPI: 산책 기록 없음 - ID: $id');
      return Result.failure('산책 기록을 찾을 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 산책 기록 조회 실패 - ID: $id, Error: $e');
      debugPrint('StackTrace: $stackTrace');
      return Result.failure('산책 기록 조회 실패: ${e.toString()}');
    }
  }
  ...
  Future<Result<List<WalkRecordEntity>>> getWalkRecordsByPetId(
    ...
    try {
      debugPrint('🌐 WalkAPI: 펫별 산책 기록 조회 - Pet ID: $petId');
      ...
      debugPrint('⚠️ WalkAPI: 응답 데이터 없음 (Pet ID: $petId)');
      return Result.failure('펫 산책 기록을 가져올 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 펫 산책 기록 조회 실패 - Pet ID: $petId, Error: $e');
      debugPrint('StackTrace: $stackTrace');
  ...
  Future<Result<WalkRecordEntity>> startWalk(
    ...
    try {
      debugPrint('🌐 WalkAPI: 산책 시작 요청 - Pet: ${walkRecord.petName}');
      ...
      if (response.statusCode == 201 && response.data != null) {
        ...
        debugPrint('✅ WalkAPI: 산책 시작 성공 - ID: ${record.id}');
        return Result.success('산책이 시작되었습니다', record);
      }

      debugPrint('⚠️ WalkAPI: 산책 시작 응답 오류');
      return Result.failure('산책을 시작할 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 산책 시작 실패 - $e');
      debugPrint('StackTrace: $stackTrace');
  ...
  Future<Result<WalkRecordEntity>> endWalk(
    ...
    try {
      debugPrint('🌐 WalkAPI: 산책 종료 요청 - ID: $walkId');
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint('✅ WalkAPI: 산책 종료 성공 - ID: $walkId');
        return Result.success('산책이 종료되었습니다', record);
      }

      debugPrint('⚠️ WalkAPI: 산책 종료 응답 오류');
      return Result.failure('산책을 종료할 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 산책 종료 실패 - ID: $walkId, Error: $e');
      debugPrint('StackTrace: $stackTrace');
  ...
  Future<Result<WalkRecordEntity>> updateWalkRecord(
    ...
    try {
      debugPrint('🌐 WalkAPI: 산책 기록 업데이트 요청 - ID: ${walkRecord.id}');
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint('✅ WalkAPI: 산책 기록 업데이트 성공 - ID: ${walkRecord.id}');
        return Result.success('산책 기록이 업데이트되었습니다', record);
      }

      debugPrint('⚠️ WalkAPI: 산책 기록 업데이트 응답 오류');
      return Result.failure('산책 기록을 업데이트할 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 산책 기록 업데이트 실패 - ID: ${walkRecord.id}, Error: $e');
      debugPrint('StackTrace: $stackTrace');
  ...
  Future<Result<void>> deleteWalkRecord(String id) async {
    try {
      debugPrint('🌐 WalkAPI: 산책 기록 삭제 요청 - ID: $id');

      final response = await _apiClient.delete(ApiEndpoints.walkById(id));

      if (response.statusCode == 200 || response.statusCode == 204) {
        debugPrint('✅ WalkAPI: 산책 기록 삭제 성공 - ID: $id');
        return Result.success('산책 기록이 삭제되었습니다');
      }

      debugPrint('⚠️ WalkAPI: 산책 기록 삭제 응답 오류');
      return Result.failure('산책 기록을 삭제할 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 산책 기록 삭제 실패 - ID: $id, Error: $e');
      debugPrint('StackTrace: $stackTrace');
  ...
  Future<Result<WalkStatistics>> getWalkStatistics({
    ...
    try {
      debugPrint('🌐 WalkAPI: 산책 통계 조회 요청');
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint('✅ WalkAPI: 산책 통계 조회 성공');
        return Result.success('산책 통계를 가져왔습니다', stats);
      }

      debugPrint('⚠️ WalkAPI: 산책 통계 응답 오류');
      return Result.failure('산책 통계를 가져올 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 산책 통계 조회 실패 - $e');
      debugPrint('StackTrace: $stackTrace');
  ...
  Future<Result<WalkRecordEntity?>> getCurrentWalk() async {
    try {
      debugPrint('🌐 WalkAPI: 현재 산책 조회 요청');
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint('✅ WalkAPI: 현재 산책 조회 성공 - ID: ${record.id}');
        return Result.success('현재 산책을 가져왔습니다', record);
      }

      if (response.statusCode == 204) {
        debugPrint('ℹ️ WalkAPI: 진행 중인 산책 없음');
        return Result.success('진행 중인 산책이 없습니다', null);
      }

      debugPrint('⚠️ WalkAPI: 현재 산책 조회 응답 오류');
      return Result.failure('현재 산책을 확인할 수 없습니다');
    } catch (e, stackTrace) {
      debugPrint('❌ WalkAPI: 현재 산책 조회 실패 - $e');
      debugPrint('StackTrace: $stackTrace');
