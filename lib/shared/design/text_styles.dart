...
class AppTextStyles {
  ...
  static final body = AppFonts.base(fontSize: 14, fontWeight: FontWeight.normal);

  static final caption = AppFonts.base(fontSize: 12, fontWeight: FontWeight.w300);
  ...
  static TextStyle get headlineMedium => AppFonts.point(fontSize: 22, fontWeight: FontWeight.w600);
