...
class AppConstants {
  ...
  static const Duration minimumLoadingDuration = const Duration(milliseconds: 500);

  // ========== 온보딩 관련 상수 ==========

  /// 페이지 전환 애니메이션
  static const Duration pageTransitionDuration = const Duration(milliseconds: 300);
  ...
  static const Duration splashAnimationDuration = const Duration(milliseconds: 2000);
