...
abstract class MockDataService {
  ...
  /// 제네릭 Mock 데이터 조회
  Future<List<T>> getMockData<T>(String dataType);
  Future<T?> getMockDataById<T>(String dataType, String id);

  /// AI 관련 Mock 데이터 (Map 형태로 반환)
  Future<List<Map<String, dynamic>>> getChatHistory();
  Future<List<Map<String, dynamic>>> getSuggestedQuestions();
  Future<List<Map<String, dynamic>>> getFavoriteQAs();
