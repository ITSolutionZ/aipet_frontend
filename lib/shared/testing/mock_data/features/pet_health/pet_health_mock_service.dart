    ...
    return [
      {
        ...
        'vaccinatedDate': DateTime.now().subtract(Duration(days: 365)),
      ...
      },
      {
        ...
        'petId': '1',
        'vaccineName': '광견병 백신',
        'vaccinatedDate': DateTime.now().subtract(Duration(days: 400)),
        'nextDueDate': DateTime.now().add(Duration(days: 95)),
        'veterinarian': '김수의사',
        'clinic': '우리동물병원',
      ...
      },
      {
        ...
        'vaccinatedDate': DateTime.now().subtract(Duration(days: 200)),
        'nextDueDate': DateTime.now().add(Duration(days: 165)),
        'veterinarian': '박수의사',
        'clinic': '24시 응급동물병원',
  ...
  static List<Map<String, dynamic>> getMockWeightRecords({String? petId}) {
    final baseRecords = [
      ...
      },
      {
        ...
        'petId': '1',
        'weight': 15.6,
        'recordedDate': DateTime.now().subtract(Duration(days: 7)),
        'notes': '약간 감소',
        'measuredBy': '병원',
      },
      {
        ...
        'petId': '1',
        'weight': 15.9,
        'recordedDate': DateTime.now().subtract(Duration(days: 14)),
        'notes': '정상',
        'measuredBy': '집',
      },
      {
