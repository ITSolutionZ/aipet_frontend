...
export const getDashboardStatistics = asyncHandler(async (req, res) => {
  ...
  return res.json(createSuccessResponse('ダッシュボード統計を取得しました', data));
});
 ...
 */
export const getPetStatistics = asyncHandler(async (req, res) => {
  const userId = req.user.uid;
  ...
  return res.json(createSuccessResponse('ペット統計を取得しました', data));
});
...
export const getActivityStatistics = asyncHandler(async (req, res) => {
  ...
  return res.json(createSuccessResponse('アクティビティ統計を取得しました', data));
});
...
export const getHealthStatistics = asyncHandler(async (req, res) => {
  ...
  return res.json(createSuccessResponse('健康統計を取得しました', data));
});
